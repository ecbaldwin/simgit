...
john.replay(anna)
anna.replay(john)
# anna.replay_squash(master, message="Anna's and John's new feature")
master.replay_squash(anna, message="Anna's and John's new feature")
repository.render(active_branches=[master])
